...
output_path="${1:-$repo_root/runtime_artifacts/uav2_near_occupancy_$(date +%Y%m%d_%H%M%S)/near_occupancy.bag}"
...
exec rosbag record __name:=uav2_near_occupancy_recorder --lz4 \
