#ifndef ASTRA_TOWER_MISSION_INSPECTION_CANDIDATE_PLANNER_H_
#define ASTRA_TOWER_MISSION_INSPECTION_CANDIDATE_PLANNER_H_
...
#endif  // ASTRA_TOWER_MISSION_INSPECTION_CANDIDATE_PLANNER_H_
